	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="updatePassword"
					method="POST">
					<div style="text-align: center">
						<img class="kelvin-login-image"
							src="${pageContext.request.contextPath}/resources/img/Picture1.png">
					</div>
					<span class="login100-form-title p-b-43"> Change Password </span>
					...
					<div class="wrap-input100 validate-input"
						...
						<input class="input100" type="password" name="password"
							id="password" required> <span class="focus-input100"></span>
